...
import { Users, MessageCircle, Calendar, Bell, ChevronRight, Code, Smartphone, Brain, Gamepad2, Settings, Shield } from "lucide-react";
...
const TeamDetail = () => {
  ...
  // Use a query to get current user ID mostly
  ...
  const joinMutation = useMutation({
    mutationFn: async () => {
      ...
      const res = await fetch(`http://localhost:3000/teams/${teamId}/join`, {
        method: "POST",
        headers: {
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      {/* Mock announcements for now as they are not relationally linked in findOne yet */}
